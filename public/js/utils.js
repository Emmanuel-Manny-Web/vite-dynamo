(() => {
  const $http = (function () {
    ...
    http_instance.defaults.headers.common["x-app-version"] = "v1.0";
    http_instance.defaults.headers.common["x-request-source"] = "Web";
    http_instance.defaults.headers.common["x-app-os"] =
